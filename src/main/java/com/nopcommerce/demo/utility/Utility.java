...
public class Utility extends ManageDriver
{
    ...
    public void verifyTheText(String expText, WebElement element)
    {
        String actualMsg=getTextFromElement(element);
        Assert.assertEquals(expText,actualMsg);
    }
    public void randomClass(By by)
    {
        Random randomGenerator = new Random();
        int randomInt = randomGenerator.nextInt(1000);
        clickOnElement(by);
        sendTextToElement(by,"username"+ randomInt +"@gmail.com");
    }
    public void randomClass(WebElement element)
    {
        Random randomGenerator = new Random();
        int randomInt = randomGenerator.nextInt(1000);
        clickOnElement(element);
        sendTextToElement(element,"username"+ randomInt +"@gmail.com");
    }
